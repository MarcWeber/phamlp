...
class SassDebugNode extends SassNode {
	...
	public function errorHandler($errno, $message) {
		echo '<div style="background-color:#ce4dd6;border-bottom:1px dashed #88338d;color:white;font:10pt verdana;margin:0;padding:0.5em 1em;width:100%;"><p style="height:auto;margin:0.25em 0;padding:0;width:100%;"><span style="font-weight:bold;">SASS '.($this->warning ? 'WARNING' : 'DEBUG').":</span> $message</p><p style=\"height:1.1em;margin:0;padding:0;padding-left:0.5em;width:100%;\">{$this->filename}::{$this->line}</p><p style=\"height:1.1em;margin:0;padding:0;padding-left:0.5em;width:100%;\">Source: {$this->source}</p></div>";
	}
}